========================================================================
    APLICACIÓN DE CONSOLA: algoritmosPlaneacion Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación algoritmosPlaneacion.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación algoritmosPlaneacion.


algoritmosPlaneacion.vcxproj
...
algoritmosPlaneacion.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado algoritmosPlaneacion.pch y un archivo de tipos precompilados llamado StdAfx.obj.
